  ...
  <div class="formbold-form-wrapper">
    ...
    <div class="formbold-form-step-2">
        <div class="formgroup">
            ...
            <select class="formbold-form-input" id="location" name="location" required>
        ...
        <div class="formgroup" id="detailed-location-group" style="display: none;">
            ...
            <select class="formbold-form-input" id="detailed-location" name="detailed_location" required>
            </select>
        </div>
    </div>
